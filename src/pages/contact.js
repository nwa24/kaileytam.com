              ...
              <Row justify="start">
                <Col lg={24} xs={24}>
                  <p style={{ fontFamily: "Avenir Light", color: "#000000" }}>
                    ...
                    occasionally copywrite for other people. On this blog,
                    you’ll find line-by-line analyses of my poems, the
                    behind-the-scenes look at the making of on the way home, as
                    well as the sporadic journal entry. What began as a fun
                    project in the midst of quarantine season became a
                    legitimate poetry chapbook, copyright and all. I’m so
                    excited for you to see not only my work, but the process
                    behind it. Thank you for all your support and enjoy!
                  </p>
                </Col>
              </Row>
            </Row>
